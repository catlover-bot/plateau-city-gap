...
describe("spatial URL state", () => {
  it("hydrates every shareable spatial dimension", () => {
    const state = parseSpatialUrl("?city=fujisawa&task=validate&urbanState=2023&mesh=523973982&scenario=B&validationSample=route-1&mapMode=plateau3d&lng=139.47&lat=35.36&z=14");
