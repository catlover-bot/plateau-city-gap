...
ADAPTERS = (
    ...
    OpenDataAdapterDefinition(
        adapter_id="estat-census-500m@2020",
        provider="総務省統計局 / e-Stat",
        dataset_family="census_population_500m",
        official_source="https://www.e-stat.go.jp/gis/statmap-search?statsId=T001192",
        discovery_method=DiscoveryMethod.OFFICIAL_API,
        download_method=DownloadMethod.API_EXPORT,
        schema_version="estat-T001192-JGD2011-500m@2020",
        license_model="政府標準利用規約 第2.0版",
        supported_formats=("CSV", "ZIP"),
        spatial_granularity="500 m standard regional mesh",
        temporal_granularity="2020-10-01 census snapshot",
        crs_handling="JGD2011 mesh code and JIS X 0410 geometry",
        version_detection=("statistics ID", "reference date", "resource URL", "SHA-256"),
        quality_rules=("KEY_CODE", "population fields", "suppression semantics", "mesh identity"),
        capabilities_provided=("population", "elderly_population"),
    ),
    OpenDataAdapterDefinition(
        adapter_id="mlit-ksj-p11@2022",
        provider="国土交通省 国土数値情報",
        dataset_family="transport_points",
        official_source="https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-P11-2022.html",
        discovery_method=DiscoveryMethod.OFFICIAL_MANIFEST,
        download_method=DownloadMethod.HTTPS,
        schema_version="ksj-P11@2022",
        license_model="国土数値情報利用約款",
        supported_formats=("GML", "SHP", "ZIP"),
        spatial_granularity="bus stop point",
        temporal_granularity="2022 snapshot",
        crs_handling="JGD2011 geographic coordinates (EPSG:6668)",
        version_detection=("dataset year", "prefecture package", "SHA-256"),
        quality_rules=("stop identity", "operator", "point geometry", "prefecture scope"),
        capabilities_provided=("transport_points",),
    ),
    OpenDataAdapterDefinition(
        adapter_id="mlit-ksj-p04@2020",
        provider="国土交通省 国土数値情報",
        dataset_family="medical_legacy",
        official_source="https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-P04-2020.html",
        discovery_method=DiscoveryMethod.OFFICIAL_MANIFEST,
        download_method=DownloadMethod.HTTPS,
        schema_version="ksj-P04@2020",
        license_model="国土数値情報利用約款",
        supported_formats=("GML", "ZIP"),
        spatial_granularity="medical facility point",
        temporal_granularity="2020-07 snapshot",
        crs_handling="JGD2011 geographic coordinates (EPSG:6668)",
        version_detection=("dataset year", "prefecture package", "SHA-256"),
        quality_rules=(
            "facility type",
        ...
        capabilities_provided=("medical_legacy_comparison",),
    ),
    OpenDataAdapterDefinition(
        adapter_id="plateau-city-model@2025",
        provider="Project PLATEAU",
        dataset_family="plateau_city_model",
        official_source="https://www.mlit.go.jp/plateau/open-data/",
        discovery_method=DiscoveryMethod.OFFICIAL_MANIFEST,
        download_method=DownloadMethod.HTTPS,
        schema_version="CityGML-2.0 / PLATEAU city release@2025",
        license_model="PLATEAU Site Policy",
        supported_formats=("CityGML", "3D Tiles", "MVT", "GeoJSON", "ZIP"),
        spatial_granularity="city model feature",
        temporal_granularity="2025 city release",
        crs_handling="source-declared JGD2011; web products EPSG:4326",
        version_detection=(
        ...
        quality_rules=("municipality code", "theme inventory", "feature count", "LOD", "CRS"),
        capabilities_provided=(
            "plateau_buildings",
            "road_network",
            "terrain",
    ...
    OpenDataAdapterDefinition(
        ...
        official_source=("https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-mesh250r6.html"),
        discovery_method=DiscoveryMethod.OFFICIAL_MANIFEST,
        download_method=DownloadMethod.HTTPS,
    ...
    OpenDataAdapterDefinition(
        adapter_id="mhlw-kayoi-no-ba@2026-06",
        provider="厚生労働省",
        dataset_family="social_participation",
        official_source="https://www.mhlw.go.jp/stf/kayoinoba_opendata_00002.html",
        discovery_method=DiscoveryMethod.OFFICIAL_MANIFEST,
        download_method=DownloadMethod.HTTPS,
        schema_version="mhlw-kayoi-no-ba@2026-06-30",
        license_model="厚生労働省ホームページ利用規約",
        supported_formats=("CSV",),
        spatial_granularity="published community activity location",
        temporal_granularity="semiannual snapshot",
        crs_handling="published latitude/longitude; datum requires review",
        version_detection=("reference date", "output date", "resource URL", "SHA-256"),
        quality_rules=(
            "municipality code",
            "publication status",
            "location identity",
        ...
        capabilities_provided=("social_participation",),
    ),
    OpenDataAdapterDefinition(
        adapter_id="wam-disability-welfare@2026-03",
        provider="独立行政法人福祉医療機構 WAM NET",
        dataset_family="welfare",
        official_source="https://www.wam.go.jp/content/wamnet/pcpub/top/sfkopendata/",
        discovery_method=DiscoveryMethod.OFFICIAL_MANIFEST,
        download_method=DownloadMethod.HTTPS,
        schema_version="wamnet-disability-welfare-open-data@2026-03",
        license_model="WAM NET掲載条件・resource利用条件の確認が必要",
        supported_formats=("CSV", "ZIP"),
        spatial_granularity="service establishment/address",
        temporal_granularity="published snapshot",
        crs_handling="published fields only; coordinates are never inferred",
        version_detection=("release month", "service package code", "resource URL", "SHA-256"),
        quality_rules=(
        ...
        capabilities_provided=("welfare",),
    ),
    OpenDataAdapterDefinition(
        adapter_id="mlit-station-passenger-s12@2021",
        provider="国土交通省 国土数値情報",
        dataset_family="station_usage",
        official_source="https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-S12-v3_1.html",
        discovery_method=DiscoveryMethod.OFFICIAL_MANIFEST,
        download_method=DownloadMethod.HTTPS,
        schema_version="ksj-S12@3.1",
        license_model="国土数値情報利用約款",
        supported_formats=("GML", "ZIP"),
        spatial_granularity="railway station point",
        temporal_granularity="2021 station passenger-count snapshot",
        crs_handling="JGD2011 geographic coordinates (EPSG:6668)",
        version_detection=("dataset year", "product specification", "resource URL", "SHA-256"),
        quality_rules=(
            "station identity",
            "operator and line",
            "observation year",
            "passenger-count unit",
            "point geometry",
        ),
        capabilities_provided=("station_usage_context",),
    ),
    OpenDataAdapterDefinition(
        adapter_id="mlit-person-trip-catalog@2026-03",
        provider="国土交通省 都市局",
        dataset_family="mobility",
        official_source="https://www.mlit.go.jp/toshi/tosiko/toshi_tosiko_tk_000031.html",
        discovery_method=DiscoveryMethod.STATIC_CATALOG,
        download_method=DownloadMethod.HTTPS,
        schema_version="mlit-person-trip-study-area-list@2026-03",
        license_model="published study metadata only; survey data terms require separate review",
        supported_formats=("HTML", "XLSX", "PDF"),
        spatial_granularity="metropolitan study area metadata",
        temporal_granularity="approximately decennial study",
        crs_handling="not applicable to catalog metadata",
        version_detection=("catalog as-of date", "study year", "resource URL"),
        quality_rules=("study area", "study year", "published unit", "licence", "privacy"),
        capabilities_provided=("mobility_context",),
    ),
)
...
SOURCES = (
    ...
    OpenDataSourceDefinition(
        source_key="estat-census-2020-500m",
        adapter_id="estat-census-500m@2020",
        provider="総務省統計局 / e-Stat",
        title="令和2年国勢調査 500mメッシュ 5歳階級別人口",
        official_url="https://www.e-stat.go.jp/gis/statmap-search?statsId=T001192",
        source_priority=1,
        default_license_id="government-standard-terms-2.0",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    OpenDataSourceDefinition(
        source_key="mlit-ksj-p11-2022",
        adapter_id="mlit-ksj-p11@2022",
        provider="国土交通省 国土数値情報",
        title="バス停留所 P11 2022",
        official_url="https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-P11-2022.html",
        source_priority=1,
        default_license_id="mlit-ksj-terms-review",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    OpenDataSourceDefinition(
        source_key="mlit-ksj-p04-2020",
        adapter_id="mlit-ksj-p04@2020",
        provider="国土交通省 国土数値情報",
        title="医療機関 P04 2020",
        official_url="https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-P04-2020.html",
        source_priority=2,
        default_license_id="mlit-ksj-terms-review",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    OpenDataSourceDefinition(
        source_key="plateau-city-model-2025",
        adapter_id="plateau-city-model@2025",
        provider="Project PLATEAU",
        title="3D都市モデル 2025年度",
        official_url="https://www.mlit.go.jp/plateau/open-data/",
        source_priority=1,
        default_license_id="plateau-site-policy-2025",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    OpenDataSourceDefinition(
    ...
    OpenDataSourceDefinition(
        ...
        official_url=("https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-mesh250r6.html"),
        source_priority=1,
        default_license_id="cc-by-4.0",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    ...
    OpenDataSourceDefinition(
        source_key="mhlw-kayoi-no-ba",
        adapter_id="mhlw-kayoi-no-ba@2026-06",
        provider="厚生労働省",
        title="通いの場のオープンデータ",
        official_url="https://www.mhlw.go.jp/stf/kayoinoba_opendata_00002.html",
        source_priority=1,
        default_license_id="unknown",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    OpenDataSourceDefinition(
        source_key="wam-disability-welfare-open-data",
        adapter_id="wam-disability-welfare@2026-03",
        provider="独立行政法人福祉医療機構 WAM NET",
        title="障害福祉サービス等情報公表システムデータのオープンデータ",
        official_url="https://www.wam.go.jp/content/wamnet/pcpub/top/sfkopendata/",
        source_priority=1,
        default_license_id="unknown",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    OpenDataSourceDefinition(
        source_key="mlit-station-passenger-count-s12",
        adapter_id="mlit-station-passenger-s12@2021",
        provider="国土交通省 国土数値情報",
        title="駅別乗降客数データ S12",
        official_url="https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-S12-v3_1.html",
        source_priority=1,
        default_license_id="mlit-ksj-terms-review",
        catalog_scope=CatalogScope.NATIONAL,
    ),
    OpenDataSourceDefinition(
        source_key="mlit-person-trip-study-catalog",
        adapter_id="mlit-person-trip-catalog@2026-03",
        provider="国土交通省 都市局",
        title="パーソントリップ調査 実施都市圏一覧",
        official_url="https://www.mlit.go.jp/toshi/tosiko/toshi_tosiko_tk_000031.html",
        source_priority=1,
        default_license_id="unknown",
        catalog_scope=CatalogScope.NATIONAL,
    ),
